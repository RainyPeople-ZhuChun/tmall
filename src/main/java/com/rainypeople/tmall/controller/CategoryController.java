...
import com.rainypeople.tmall.util.UploadedImageFile;
...
public class CategoryController {
    ...
    public String updata(Category c,HttpSession session,UploadedImageFile uploadedImageFile) throws IOException {
